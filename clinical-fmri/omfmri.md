...
<p>This free test battery is only available due to the support of Dr. Agha Khani, <a href="https://www.vch.ca/en/service/epilepsy-programs" target="_blank" rel="noopener">VGH Epilepsy</a>, the <a href="https://vghfoundation.ca/" target="_blank" rel="noopener">VGH Foundation</a>, the <a href="https://coramdeofoundation.com/" target="_blank" rel="noopener">Coram Deo foundation</a>, and the <a href="https://www.aan.com" target="_blank" rel="noopener">American Academy of Neurology</a>.</p>

---

## Download

<a href="https://forms.gle/6W5usKecVbtXNirXA" target="_blank" rel="noopener" class="btn">Download omfMRI ↓</a>

---

## Overview

The OMfMRI battery was developed to provide a standardised, validated approach to language mapping with fMRI. It is designed for clinical pre-surgical planning — primarily in patients with epilepsy being evaluated for resective surgery — and provides robust assessment of language lateralisation and the - broad - localisation of key language regions.
...
Dr. Benjamin consults to clinical programs on setting up or improving language fMRI services, including implementation of the OMfMRI battery. For enquiries, please use the [contact page](/contact/).
